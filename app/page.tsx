  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-4 py-6 md:py-8 xl:px-72">
          {/* Debug Info */}
          <div className="mb-4 p-3 bg-slate-800/80 backdrop-blur-sm border border-slate-700 rounded-lg text-sm">
            <p className="text-slate-300">
              🐛 DEBUG [CLIENT-ONLY]: Loading: {isLoading.toString()}, 
