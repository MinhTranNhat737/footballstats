...
function MatchCard({ match, onSelect }: MatchCardProps) {
  ...
  return (
    <div
      onClick={handleClick}
      className="group p-4 rounded-lg border border-slate-700/50 bg-slate-800/30 hover:bg-slate-800/60 hover:border-slate-600 cursor-pointer transition-all duration-300 backdrop-blur-sm"
    >
          ...
          <div className="w-full max-w-4xl mx-auto px-2">
            <div className="grid grid-cols-12 items-center gap-1 h-10">
              ...
              <div className="col-span-2 flex justify-center">
                <div
                  className={`w-14 h-6 flex items-center justify-center rounded text-xs font-bold transition-colors ${
                    isFinished 
